                        ...
                        <div class="about-right mb-90">
                            ...
                            <div class="social-share pt-30">
                                <div class="section-tittle">
                                    ...
                                    <ul>
                                        <li><a href="#"><img src="{{asset('fontend/img/news/icon-ins.png')}}" alt=""></a></li>
                                        <li><a href="#"><img src="{{asset('fontend/img/news/icon-fb.png')}}" alt=""></a></li>
                                        <li><a href="#"><img src="{{asset('fontend/img/news/icon-tw.png')}}" alt=""></a></li>
                                        <li><a href="#"><img src="{{asset('fontend/img/news/icon-yo.png')}}" alt=""></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
